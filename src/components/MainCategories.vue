  ...
  <section class="mx-auto max-w-352 px-4 py-6 sm:px-6 lg:py-8">
    ...
    >
      <article
        ...
        :key="category.title"
        class="group min-w-[60%] snap-start overflow-hidden rounded-2xl border border-violet-300/10 bg-[#090b19]/85 shadow-xl shadow-violet-950/25 transition sm:min-w-[44%]"
      >
        <div
        ...
        >
          ...
          ></div>
          <div
            class="absolute left-1/2 top-1/2 grid size-18 -translate-x-1/2 -translate-y-1/2 place-items-center rounded-3xl border border-white/20 bg-black/25 shadow-2xl shadow-fuchsia-500/20 backdrop-blur"
          >
    ...
    <div class="hidden grid-cols-2 gap-3 lg:grid lg:grid-cols-5">
      <article
        v-for="category in categories"
        :key="category.title"
        class="group overflow-hidden rounded-2xl border border-violet-300/10 bg-[#090b19]/85 shadow-xl shadow-violet-950/25 transition hover:-translate-y-1 hover:border-fuchsia-300/30 hover:bg-[#101226]"
      >
        <div
